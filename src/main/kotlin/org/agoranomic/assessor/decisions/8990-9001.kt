...
fun assessment8990to9001() = assessment {
    name("8990-9001")
    url("https://mailman.agoranomic.org/cgi-bin/mailman/private/agora-official/2023-June/017166.html")
    quorum(5)
...
Outshined the Sun. This bonus SHOULD be compensated if repealed.
    ...
    voting {
        ...
        votes(ais523) {
            ...
            AGAINST on 8999
            AGAINST on 9000
            resolvedConditional(AGAINST, "P9000 has not been and cannot be resolved as ADOPTED") on 9001
        }
