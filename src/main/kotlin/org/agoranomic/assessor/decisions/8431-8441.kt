...
@UseAssessment
fun assessment8431to8441() = assessment {
    name("8431-8441")
    url("https://mailman.agoranomic.org/cgi-bin/mailman/private/agora-official/2020-June/013811.html")
    quorum(7)
  ...
  specified type."""
    ...
    voting {
        ...
        votes(Falsifian) {
            ...
            PRESENT on 8432
            endorse(Aris) on 8433 comment legacyConditionalComment("8432 will not be adopted")
            PRESENT on 8434
            PRESENT on 8435
            FOR on 8436
