...
fun assessment8946to8951() = assessment {
    name("8946-8951")
    url("https://mailman.agoranomic.org/cgi-bin/mailman/private/agora-official/2023-April/016981.html")
    quorum(3)
...
and appending (to the end):
    ...
    voting {
        ...
        votes(Yachay) {
            ...
            resolvedConditional(
                FOR,
                "Janet has pledged not to collect the Radiance e would be eligible to claim from the proposal passing"
            ) on 8947
